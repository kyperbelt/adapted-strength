    ...
    return (
        <div className="min-h-screen pt-16 bg-white">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                {/* Coach Credentials - Matching Calendly Style */}
                <div className="text-center mb-8 pb-6 border-b border-gray-200">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Alex-Andre Palting</h2>
                    <div className="text-gray-700 space-y-1">
                        <p>M.S. Exercise Physiology</p>
                        <p>NSCA - Certified Personal Trainer</p>
                        <p>USA Weightlifting Level 2 | USA Powerlifting Club Coach</p>
                        <p className="font-semibold">8+ Years of Coaching Experience</p>
                    </div>
                </div>

                {/* Benefits Cards - Clean White Style */}
                ...
                {/* Calendly Embed Section - Seamless Integration */}
                <div className="mb-8">
                    ...
                    {/* Calendly Container - Matching White Background */}
                ...
                {/* Additional Information - Clean White Style */}
