...
export default function Chat() {
            ...
            UserApi.getProfileInformation()
                ...
                .then(chatResponse => {
                    if (chatResponse.status === HttpStatus.OK) {
                        ...
                        throw new Error(`Error occurred when fetching chat information\nHTTP Status: ${chatResponse.status}`)
                    }
                })
                .then(chatData => {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="mx-2 mb-2 absolute bottom-0 inset-x-0 border border-gray-200 p-4 rounded-b-xl bg-gray-100">
