...
export function PrimaryButton({ className, children, ...props }) {
  return <BasicButton className={` ${className} text-white bg-accent hover:bg-accent-dark focus:ring-4 focus:bg-accent-light font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none disabled:bg-primary-dark disabled:hover:bg-primary-dark`} {...props}>{children}</BasicButton>
}
